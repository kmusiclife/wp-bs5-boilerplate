<?php 
    ...
    if(!$thumbnail_image) $thumbnail_image = get_template_directory_uri().'/dist/images/default/thumbnail.jpg';
    if(!$thumbnail_image_square) $thumbnail_image_square = get_template_directory_uri().'/dist/images/default/thumbnail-square.jpg';
