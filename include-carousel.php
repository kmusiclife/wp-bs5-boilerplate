  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-none d-md-block w-100"
        src="<?php echo get_template_directory_uri() ?>/dist/images/mainimage/mainimage01-1200x630.jpeg"
        alt="<?php echo bloginfo('sitename') ?> スライド1"
      />
      <img class="d-block d-md-none w-100"
        src="<?php echo get_template_directory_uri() ?>/dist/images/mainimage/mainimage01-600x630.jpeg"
        alt="<?php echo bloginfo('sitename') ?> スライド1"
      />
    </div>
    <div class="carousel-item">
      <img class="d-none d-md-block w-100"
        src="<?php echo get_template_directory_uri() ?>/dist/images/mainimage/mainimage02-1200x630.jpeg"
        alt="<?php echo bloginfo('sitename') ?> スライド2"
      />
      <img class="d-block d-md-none w-100"
        src="<?php echo get_template_directory_uri() ?>/dist/images/mainimage/mainimage02-600x630.jpeg"
        alt="<?php echo bloginfo('sitename') ?> スライド2"
      />
    </div>
  </div>
